              ...
              >
                {loading ? (
                  ...
                  <div className="flex items-center w-full">
                    ...
                    <div className="flex-1 mr-2 overflow-hidden">
                      ...
                      {profileData.learning_style && (
                        <p
                          className={`text-xs px-1.5 py-0.5 rounded-sm leading-none truncate transition-colors ${
                            getLearningStyleColor(profileData.learning_style).bg
                          } ${
                            getLearningStyleColor(profileData.learning_style)
                              .text
                          }`}
                        >
                          {profileData.learning_style}
                  ...
                  <div className="flex items-center w-full">
                    ...
                    <div className="flex-1 mr-2">
                      <p className="text-xs font-medium text-[#424D66] truncate">
                        User
                      </p>
                      <p className="text-xs bg-gray-300 px-1.5 py-0.5 rounded-sm truncate">
                        -
                      </p>
                    </div>
                    <ChevronDown size={14} className="ml-auto" />
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center mb-3">
                ...
                <div className="flex-1">
                  ...
                  {profileData?.learning_style && (
                    <p
                      className={`text-xs px-2 py-1 rounded-sm inline-block transition-colors ${
                        getLearningStyleColor(profileData.learning_style).bg
                      } ${

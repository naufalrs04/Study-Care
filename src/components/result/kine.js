        ...
        <div className="flex-1 max-w-md relative">
          ...
          <div className="mb-8 text-right">
            <p className="text-[#A4A4A4] text-lg font-semibold leading-relaxed">
              Pembelajar kinestetik adalah individu yang belajar paling baik
              melalui pengalaman langsung dan aktivitas fisik. Mereka cenderung
              menyukai metode pembelajaran yang melibatkan gerakan, praktik,
              atau simulasi. Pembelajar ini memahami konsep dengan lebih baik
              ketika mereka bisa menyentuh, memanipulasi objek, atau melakukan

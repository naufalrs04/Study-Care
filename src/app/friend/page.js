            ...
            <div className="flex items-start space-x-6 mb-8">
              ...
              <div className="flex-1">
                ...
                {friend.learning_style && (
                  <span className="inline-block px-3 py-1 text-sm font-medium text-amber-700 bg-gradient-to-r from-yellow-200 to-amber-200 rounded-full">
                    {friend.learning_style}
                  </span>
                )}
                {friend.bio && (

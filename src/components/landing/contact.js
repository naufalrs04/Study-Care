          ...
          <div className="flex flex-col gap-15 md:gap-5 md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 md:pr-12">
              ...
              <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                Kami siap membantu perjalanan belajar Anda. Hubungi tim StudyFinder untuk konsultasi, 
                pertanyaan, atau saran mengenai platform pembelajaran kami.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Jl. Pendidikan No. 123, Semarang, Jawa Tengah</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+62 24 7648 1000</p>
                  </div>
                </div>

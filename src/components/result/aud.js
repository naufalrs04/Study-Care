        ...
        <div className="flex-1 max-w-md relative">
          ...
          <div className="mb-8 text-right">
            <p className="text-[#A4A4A4] text-lg font-semibold leading-relaxed">
              Pembelajar auditori adalah individu yang lebih mudah memahami dan
              mengingat informasi melalui pendengaran. Mereka cenderung menyerap
              informasi secara efektif melalui penjelasan lisan, diskusi,
              ceramah, atau rekaman suara. Suara, intonasi, dan ritme menjadi
              faktor penting dalam proses belajar mereka.
            </p>
          </div>
